...
#if defined _MSC_VER || defined __CYGWIN__ || ( ( defined __i386 || defined _M_IX86 || defined __x86_64__ || defined _M_X64 ) && !defined __ANDROID__ ) || (__ARM_ARCH >= 6 && !defined __SWITCH__)
...
#if __ARM_ARCH >= 6 && !defined __SWITCH__
